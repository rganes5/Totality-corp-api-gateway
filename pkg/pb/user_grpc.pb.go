...
func (c *userServiceClient) GetUserDataList(ctx context.Context, in *GetUserDataListRequest, opts ...grpc.CallOption) (*GetUserDataListResponse, error) {
	out := new(GetUserDataListResponse)
	err := c.cc.Invoke(ctx, "/pb.UserService/GetUserDataList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GetUserDataList(context.Context, *GetUserDataListRequest) (*GetUserDataListResponse, error) {
...
func _UserService_GetUserDataList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserDataListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetUserDataList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/GetUserDataList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserDataList(ctx, req.(*GetUserDataListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetUserDataList_Handler,
		},
	},
